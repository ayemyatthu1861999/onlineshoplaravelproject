        ...
        <table class="table">
          ...
          <tbody id="shoppingcart_table">
            <tr>
              ...
              <td> 
                <img src="{{ asset('front/css/image/item/saisai_one.jpg')}}" class="cartImg">           
              </td>
              <td> 
                <p> Item Name </p>
                <p> Code Number</p>
            ...
            <tr>
              ...
              <td> 
                <img src="{{ asset('front/css/image/item/saisai_two.jpg')}}" class="cartImg">           
              </td>
              <td> 
                <p> Item Name </p>
                <p> Code Number</p>
          ...
          <tfoot id="shoppingcart_tfoot">
            <tr>
              ...
              <td colspan="5"> 
                <textarea class="form-control notes" id="notes" placeholder="Your notes here!"></textarea>
              </td>
              <td colspan="3">
                @role('Customer')
                ...
                @else
                 <a href="{{route('loginpage')}}"button class="btn btn-secondary btn-block mainfullbtncolor "> 
                 Login To Check Out 
                </a>
                @endrole
              </td>
