...
<div id="mySidebar" class="sidebar">
	...
	<div class="mt-3">
		...
		<img src="{{ asset('front/css/image/download.png') }}" class="img-fluid ml-2 text-center" style="width: 150px">
		<hr>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="{{ asset('front/css/image/banner/ac.jpg') }}" class="d-block w-100 bannerImg" alt="...">
		</div>
		<div class="carousel-item">
			<img src="{{ asset('front/css/image/banner/giordano.jpg') }}" class="d-block w-100 bannerImg" alt="...">
		</div>
		<div class="carousel-item">
			<img src="{{ asset('front/css/image/banner/garnier.jpg') }}" class="d-block w-100 bannerImg" alt="...">
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
			<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				<img src="{{ asset('front/css/image/category/category_one.png') }}" class="card-img-top" alt="...">
				<div class="card-body">
		...
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
			<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				<img src="{{ asset('front/css/image/category/category_two.png') }}" class="card-img-top" alt="...">
				<div class="card-body">
		...
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
			<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				<img src="{{ asset('front/css/image/category/category_three.png') }}" class="card-img-top" alt="...">
				<div class="card-body">
		...
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
			<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				<img src="{{ asset('front/css/image/category/category_four.png') }}" class="card-img-top" alt="...">
				<div class="card-body">
		...
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
			<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				<img src="{{ asset('front/css/image/category/category_five.png') }}" class="card-img-top" alt="...">
				<div class="card-body">
		...
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
			<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				<img src="{{ asset('front/css/image/category/category_six.png') }}" class="card-img-top" alt="...">
				<div class="card-body">
		...
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
			<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				<img src="{{ asset('front/css/image/category/category_seven.png') }}" class="card-img-top" alt="...">
				<div class="card-body">
		...
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
			<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				<img src="{{ asset('front/css/image/category/category_eight.jpg') }}" class="card-img-top" alt="...">
				<div class="card-body">
		...
		<div class="col-12">
			<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
				<div class="MultiCarousel-inner">
					<div class="item">
						<div class="pad15">
							<img src="{{ asset('front/css/image/item/saisai_one.jpg') }}" class="img-fluid">
					...
					<div class="item">
						<div class="pad15">
							<img src="{{ asset('front/css/image/item/saisai_two.jpg') }}" class="img-fluid">
							<p class="text-truncate">Multi Item Carousel</p>
							<p class="item-price">
								<span class="d-block">230,000 Ks </span>
							</p>
					...
					<div class="item">
						<div class="pad15">
							<img src="{{ asset('front/css/image/item/saisai_three.jpg') }}" class="img-fluid">
							<p class="text-truncate">Multi Item Carousel</p>
							<p class="item-price">
								<strike>250,000 Ks </strike> 
								<span class="d-block">230,000 Ks </span>
